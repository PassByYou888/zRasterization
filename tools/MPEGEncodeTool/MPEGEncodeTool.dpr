...
uses
  ...
  ZR.MemoryRaster,
  FMX.Types,
  MPEGEncodeToolFrm in 'MPEGEncodeToolFrm.pas' {MPEGEncodeToolForm},
  StyleModuleUnit in '..\Common\StyleModuleUnit.pas' {StyleDataModule: TDataModule};

{$R MPEGEncodeTool.res}
...
begin
  ...
  Application.CreateForm(TMPEGEncodeToolForm, MPEGEncodeToolForm);
  Application.Run;
  FreeGlobalMedia();
end.
