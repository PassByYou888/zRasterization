...
begin
  ...
  for i := 0 to inputFiles.Count - 1 do
    begin
      ...
      if (umlMultipleMatch(['*.seq'], sour)) and (TSequenceMemoryZR.CanLoadFile(sour)) then
        begin
          SeqRaster := TSequenceMemoryZR.Create;
          raster := TMZR.Create;
      ...
      else if TMZR.CanLoadFile(sour) then
        begin
          raster := TMZR.Create;
