...
uses
  ...
  ZR.MemoryRaster,
  FMX.Types,
  StringTranslate_FMX_Frm in 'StringTranslate_FMX_Frm.pas' {StringTranslate_FMX_Form},
...
begin
  ...
  Application.CreateForm(TStringTranslate_FMX_Form, StringTranslate_FMX_Form);
  Application.Run;
  FreeGlobalMedia();
end.
