...
uses
  ...
  ZR.Core, ZR.PascalStrings, ZR.MemoryStream, ZR.UnicodeMixedLib, ZR.Cipher, ZR.Status,
  ZR.Expression, ZR.OpCode, ZR.Parsing, ZR.IOThread,
  ZR.Json, ZR.ZDB2, ZR.ZDB2.Json;
