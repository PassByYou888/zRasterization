...
uses
  ...
  ZR.Core, ZR.PascalStrings, ZR.UnicodeMixedLib, ZR.Status, ZR.DFE,
  ZR.TextDataEngine, ZR.ListEngine, ZR.DrawEngine, ZR.MemoryRaster, ZR.MemoryStream, ZR.Geometry2D,
  ZR.DrawEngine.SlowFMX, ZR.MemoryRaster.JPEG.Type_LIB;
...
begin
  TComputeThread.RunP(nil, nil, procedure(Sender: TComputeThread)
    var
      oriMR: TMZR;
    begin
      oriMR := NewZRFromFile(TPath.GetLibraryPath+'lena.bmp');
