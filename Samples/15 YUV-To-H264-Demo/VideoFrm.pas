...
uses
  ...
  ZR.MemoryRaster, ZR.DrawEngine, ZR.Geometry2D, ZR.DrawEngine.SlowFMX,
  ZR.h264.Y4M, ZR.h264, ZR.PascalStrings, ZR.Core, ZR.UnicodeMixedLib;
  ...
  begin
    ...
    for i := yR.CurrentFrame to yR.FrameCount - 1 do
      begin
        ...
        raster.DrawText('hello world', 0, 0, Vec2(1, 0), -15, 0.9, 28, ZRColorF(1, 0, 0, 0.5));
