...
uses
  ZR.Core, ZR.PascalStrings, ZR.UPascalStrings, ZR.MemoryRaster.JPEG.Type_LIB, ZR.MemoryRaster.JPEG.Marker;
...
uses ZR.MemoryRaster.JPEG.Coder, ZR.MemoryRaster.JPEG.Image_LIB;
