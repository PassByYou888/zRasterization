...
uses ZR.Core, ZR.ZDB.ObjectData_LIB, ZR.UnicodeMixedLib, ZR.PascalStrings, ZR.UPascalStrings, ZR.ListEngine, ZR.ZDB2, ZR.HashList.Templet;

type
  TItemHandle = ZR.ZDB.ObjectData_LIB.TItemHandle_;
  PItemHandle = ^TItemHandle;
  TFieldHandle = ZR.ZDB.ObjectData_LIB.TField;
  PFieldHandle = ^TFieldHandle;
  TItemSearch = ZR.ZDB.ObjectData_LIB.TSearchItem_;
  PItemSearch = ^TItemSearch;
  TFieldSearch = ZR.ZDB.ObjectData_LIB.TSearchField_;
  PFieldSearch = ^TFieldSearch;
  TItemRecursionSearch = ZR.ZDB.ObjectData_LIB.TRecursionSearch_;
...
var
  FieldHnd: TFieldHandle;
  i: Integer;
  h: ZR.ZDB.ObjectData_LIB.THeader;
begin
  Result := False;
  SetLength(output, 0);
