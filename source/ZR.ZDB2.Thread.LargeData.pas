...
{$ENDIF FPC}
  ...
  ZR.HashList.Templet, ZR.DFE, ZR.Geometry2D,
  ZR.Notify, ZR.ZDB2.Thread.Queue, ZR.ZDB2.Thread;
...
type
  ...
  TZDB2_Custom_Data_Pool = TZR_BL<TZDB2_Th_Engine_Data>;
  TZDB2_Custom_Small_Data_Pool = TZR_BL<Int64>;
  TZDB2_Custom_Medium_Data_Pool = TZR_BL<Int64>;
  TZDB2_Custom_Large_Data_Pool = TZR_BL<Int64>;
