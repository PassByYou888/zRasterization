...
begin
  if Dest is TMZR then
    begin
      TMZR(Dest).SetSize(ImageHeader.Width, ImageHeader.Height, 0);
      DrawToRaster(TMZR(Dest));
    end;
end;
...
var
  ...
  DataStream: TMS64;
begin
  if Source is TMZR then
    with TMZR(Source) do
      begin
        // Assign
        AssignPropertiesFromRaster(TMZR(Source));
