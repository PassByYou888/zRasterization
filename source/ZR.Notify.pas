...
{$IFDEF FPC}
  ZR.FPC.GenericList,
{$ENDIF FPC}
  ZR.Core, ZR.PascalStrings, ZR.UPascalStrings, ZR.DFE, ZR.Cadencer;
...
{$ENDIF FPC}
  TN_Post_Execute_List_Struct = TCritical_ZR_BL<TN_Post_Execute>;
...
uses ZR.Status, ZR.UnicodeMixedLib;
