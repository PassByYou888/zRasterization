...
{$IFDEF FPC}
  ZR.FPC.GenericList,
{$ENDIF FPC}
  ZR.PascalStrings, ZR.UPascalStrings;
...
{$REGION 'Generics decl'}
  ...
  TStringBigList_Decl = TZR_BL<SystemString>;
  ...
  TPascalStringBigList_Decl = TZR_BL<TPascalString>;
...
{$IFDEF FPC}
  streamex,
{$ENDIF FPC}
  ZR.MemoryStream, ZR.Status, ZR.UnicodeMixedLib, ZR.Parsing, ZR.Expression, ZR.UReplace;
