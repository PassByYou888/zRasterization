...
{$ENDIF FPC}
  ...
  ZR.Core, ZR.PascalStrings, ZR.UPascalStrings, ZR.ListEngine;
...
{$IF Defined(WIN32) or Defined(WIN64)}
  ZR.MD5,
{$ENDIF}
  ZR.Cipher, ZR.Status, ZR.MemoryStream, ZR.FragmentBuffer, ZR.Json;
