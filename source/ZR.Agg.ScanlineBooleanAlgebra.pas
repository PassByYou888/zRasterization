...
(*
  ...
  ////////////////////////////////////////////////////////////////////////////////
*)
unit ZR.Agg.ScanlineBooleanAlgebra;
...
type
  ...
  public
    ...
    constructor Create1(f1: TAggBoolScanLineFunctor1; CoverShift: Cardinal = ZR.Agg.Basics.CAggCoverShift);
    constructor Create2(f2: TAggBoolScanLineFunctor2; CoverShift: Cardinal = ZR.Agg.Basics.CAggCoverShift);
  end;
...
constructor TAggBoolScanLineFunctor.Create1(f1: TAggBoolScanLineFunctor1;
  CoverShift: Cardinal = ZR.Agg.Basics.CAggCoverShift);
begin
