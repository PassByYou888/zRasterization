...
{$ENDIF FPC}
  ZR.Core,
  ZR.Status, ZR.PascalStrings, ZR.UPascalStrings, ZR.UnicodeMixedLib, ZR.ListEngine, ZR.Geometry2D;
...
type
  ...
  public type
    ...
    TTime_List = TZR_BL<T_>;
    TTime_Data_L_ = TZR_BL<TTime_Hash_Pool>;
    TDateTime_L = TZR_BL<TDateTime>;
