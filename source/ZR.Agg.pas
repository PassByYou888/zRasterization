...
uses
  Math,
  ZR.Agg.Basics, ZR.Agg.Math, ZR.Agg.Array_LIB, ZR.Agg.TransAffine, ZR.Agg.TransViewport, ZR.Agg.PathStorage, ZR.Agg.ConvStroke, ZR.Agg.ConvDash, ZR.Agg.ConvTransform, ZR.Agg.ConvCurve,
  ZR.Agg.RenderingBuffer, ZR.Agg.RendererBase, ZR.Agg.RendererScanLine, ZR.Agg.SpanGradient, ZR.Agg.SpanImageFilterRgba, ZR.Agg.SpanImageResampleRgba, ZR.Agg.SpanConverter,
  ZR.Agg.SpanInterpolatorLinear, ZR.Agg.SpanAllocator, ZR.Agg.RasterizerScanLineAA, ZR.Agg.GammaFunctions, ZR.Agg.ScanlineUnpacked, ZR.Agg.Arc, ZR.Agg.BezierArc, ZR.Agg.RoundedRect,
  ZR.Agg.PixelFormat, ZR.Agg.PixelFormatRgba, ZR.Agg.Color32, ZR.Agg.MathStroke, ZR.Agg.ImageFilters, ZR.Agg.VertexSource, ZR.Agg.RenderScanlines,
  ZR.Agg.AlphaMaskUnpacked8, ZR.Agg.ArrowHead, ZR.Agg.BitsetIterator, ZR.Agg.Blur, ZR.Agg.BoundingRect, ZR.Agg.BSpline, ZR.Agg.ClipLiangBarsky, ZR.Agg.ColorConversion, ZR.Agg.Control,
  ZR.Agg.ConvAdaptorVcgen, ZR.Agg.ConvAdaptorVpgen, ZR.Agg.ConvBSpline, ZR.Agg.ConvClipPolygon, ZR.Agg.ConvClipPolyline, ZR.Agg.ConvConcat, ZR.Agg.ConvContour, ZR.Agg.ConvMarker,
  ZR.Agg.ConvMarkerAdaptor, ZR.Agg.ConvSegmentator, ZR.Agg.ConvShortenPath, ZR.Agg.ConvSmoothPoly, ZR.Agg.Curves, ZR.Agg.DdaLine, ZR.Agg.Ellipse, ZR.Agg.EllipseBresenham, ZR.Agg.GammaLUT,
  ZR.Agg.GradientLut, ZR.Agg.LineAABasics, ZR.Agg.PathStorageInteger, ZR.Agg.PatternFiltersRgba, ZR.Agg.PixelFormatAlphaMaskAdaptor, ZR.Agg.PixelFormatGray, ZR.Agg.PixelFormatRgb,
  ZR.Agg.PixelFormatRgbPacked, ZR.Agg.PixelFormatTransposer, ZR.Agg.QuadratureOscillator, ZR.Agg.RasterizerCellsAA, ZR.Agg.RasterizerCompoundAA, ZR.Agg.RasterizerOutline,
  ZR.Agg.RasterizerOutlineAA, ZR.Agg.RasterizerScanLine, ZR.Agg.RasterizerScanlineClip, ZR.Agg.RendererMarkers, ZR.Agg.RendererMultiClip, ZR.Agg.RendererOutlineAA,
  ZR.Agg.RendererOutlineImage, ZR.Agg.RendererPrimitives, ZR.Agg.RenderingBufferDynaRow, ZR.Agg.Scanline, ZR.Agg.ScanlineBin, ZR.Agg.ScanlineBooleanAlgebra, ZR.Agg.ScanlinePacked,
  ZR.Agg.ScanlineStorageAA, ZR.Agg.ScanlineStorageBin, ZR.Agg.ShortenPath, ZR.Agg.SimulEq, ZR.Agg.SpanGenerator, ZR.Agg.SpanGouraud, ZR.Agg.SpanGouraudGray, ZR.Agg.SpanGouraudRgba,
  ZR.Agg.SpanGradientAlpha, ZR.Agg.SpanGradientContour, ZR.Agg.SpanGradientImage, ZR.Agg.SpanImageFilter, ZR.Agg.SpanImageFilterGray, ZR.Agg.SpanImageFilterRgb, ZR.Agg.SpanImageResample,
  ZR.Agg.SpanImageResampleGray, ZR.Agg.SpanImageResampleRgb, ZR.Agg.SpanInterpolatorAdaptor, ZR.Agg.SpanInterpolatorPerspective, ZR.Agg.SpanInterpolatorTrans, ZR.Agg.SpanPattern,
  ZR.Agg.SpanPatternFilterGray, ZR.Agg.SpanPatternFilterRgb, ZR.Agg.SpanPatternFilterRgba, ZR.Agg.SpanPatternResampleGray, ZR.Agg.SpanPatternResampleRgb,
  ZR.Agg.SpanPatternResampleRgba, ZR.Agg.SpanPatternRgb, ZR.Agg.SpanPatternRgba, ZR.Agg.SpanSolid, ZR.Agg.SpanSubdivAdaptor, ZR.Agg.Spiral, ZR.Agg.TransBilinear, ZR.Agg.TransDoublePath,
  ZR.Agg.TransPerspective, ZR.Agg.TransSinglePath, ZR.Agg.TransWarpMagnifier, ZR.Agg.VcgenBSpline, ZR.Agg.VcgenContour, ZR.Agg.VcgenDash, ZR.Agg.VcgenMarkersTerm, ZR.Agg.VcgenSmoothPoly1,
  ZR.Agg.VcgenStroke, ZR.Agg.VcgenVertexSequence, ZR.Agg.VertexSequence, ZR.Agg.VpGen, ZR.Agg.VpGenClipPolygon, ZR.Agg.VpGenClipPolyline, ZR.Agg.VpGenSegmentator;
