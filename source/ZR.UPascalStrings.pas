...
{$ELSE FPC}
  USystemChar = ZR.PascalStrings.SystemChar;
  USystemString = ZR.PascalStrings.SystemString;
  TUArrayChar = ZR.PascalStrings.TArrayChar;
  PUSystemString = ZR.PascalStrings.PSystemString;
  PUPascalString = ZR.PascalStrings.PPascalString;
{$ENDIF FPC}
