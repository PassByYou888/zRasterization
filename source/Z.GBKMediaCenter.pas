...
uses Classes, ZR.Status, ZR.Core, ZR.PascalStrings, ZR.UPascalStrings,
  ZR.MemoryStream, ZR.ListEngine, ZR.TextDataEngine, ZR.UnicodeMixedLib,
...
begin
  while not GBKMediaInited.V do
      ZR.Core.CheckThreadSynchronize(10);
end;
