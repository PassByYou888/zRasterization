...
{$IFDEF FPC}
  ZR.FPC.GenericList,
{$ENDIF FPC}
  ZR.PascalStrings, ZR.UPascalStrings, ZR.UnicodeMixedLib, ZR.Status, ZR.MemoryStream, ZR.ListEngine,
  ZR.ZDB.ObjectData_LIB, ZR.ZDB, ZR.ZDB.ItemStream_LIB,
  ZR.HashList.Templet, ZR.DFE, ZR.ZDB2, ZR.IOThread, ZR.Cipher;
...
type
  ...
  TZDB2_FI_Pool_Decl = TZR_BL<TZDB2_FI>;
