...
uses Classes, SysUtils,
  ZR.Core, ZR.MemoryStream, ZR.PascalStrings,
  ZR.MemoryRaster.JPEG.Type_LIB,
  ZR.MemoryRaster.JPEG.Marker,
  ZR.MemoryRaster.JPEG.MapIterator,
  ZR.MemoryRaster.JPEG.DICT,
  ZR.MemoryRaster.JPEG.BitStream,
  ZR.MemoryRaster.JPEG.Huffman,
  ZR.MemoryRaster.JPEG.Lossless,
  ZR.MemoryRaster.JPEG.ColorTransforms,
  ZR.MemoryRaster.JPEG.Coder;
